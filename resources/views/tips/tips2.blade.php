...
<style>
    ...
    <!-- Hero Section untuk Tips 2 dengan Gradient Modern -->
    <section class="relative bg-gradient-to-br from-green-600 via-green-500 to-emerald-600 text-white py-20 md:py-28 px-4 overflow-hidden">
        <div class="max-w-6xl mx-auto text-center relative z-10">
            ...
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Tips 2<br>
                <span class="text-yellow-300">Gunakan Pupuk Organik dengan Tepat</span>
            </h1>
            <p class="text-lg md:text-xl mb-8 text-green-50 max-w-2xl mx-auto">
                Panduan penggunaan pupuk organik untuk hasil panen yang lebih baik
            </p>
                ...
                <div class="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div class="flex-shrink-0">
                        <div class="bg-gradient-to-br from-green-100 to-emerald-200 w-40 h-40 rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform duration-300">
                            <img src="{{ asset('storage/images/tips-2.png') }}" alt="Ikon Pupuk Organik"
                    ...
                    <div class="text-center md:text-left flex-1">
                        <h2 class="text-5xl md:text-6xl font-bold text-green-600 mb-4">TIPS 2</h2>
                        ...
                        <div class="space-y-4 text-gray-700 text-base md:text-lg leading-relaxed text-justify">
                            <p>
                                Provinsi Gorontalo memiliki potensi pertanian yang besar, dan salah satu kunci keberhasilannya adalah penggunaan pupuk organik secara tepat. Pupuk organik membantu memperbaiki struktur tanah, menambah unsur hara alami, serta menjaga keseimbangan ekosistem tanah.
                            </p>
                            <p>
                                Gunakan kompos atau pupuk kandang matang agar tidak merusak akar tanaman. Sebarkan pupuk secara merata di lahan, lalu aduk hingga tercampur dengan tanah. Untuk hasil lebih baik, lakukan pemupukan beberapa minggu sebelum tanam agar unsur hara terserap sempurna.
                            </p>
                            <p>
                                Selain itu, petani dapat menambahkan pupuk hayati untuk meningkatkan aktivitas mikroorganisme yang bermanfaat bagi pertumbuhan tanaman. Dengan penggunaan pupuk organik yang tepat, petani Gorontalo dapat meningkatkan kesuburan tanah sekaligus menjaga kelestarian lingkungan.
                            </p>
                        </div>
                    </div>
                </div>
